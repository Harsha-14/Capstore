...
public class CapstoreController {
	...
	-	 * Description : Removing a product from wishList using product Id
		 ...
		 * Description : Placing order for the customer
		 *
		 * @param username 
		 ...
		 * @return
		 */
		@GetMapping("/placeOrder/{username}/{productId}/{quantity}/{price}/{addrId}")
		...
		public  int validateCoupon(@PathVariable String couponCode,@PathVariable int amount) throws InvalidCoupon{
